...
import loyal.Battle.Actions.SootingSunlightDefensiveSingleTargetAbility;
...
public class Cleric extends PlayingCharacter
{
	...
	SootingSunlightDefensiveSingleTargetAbility sootingSunLight;
	...
	public Cleric(String name, CharacterType type)
	{
		...
		sootingSunLight = new SootingSunlightDefensiveSingleTargetAbility(this);
